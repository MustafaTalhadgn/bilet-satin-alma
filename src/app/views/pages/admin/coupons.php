<?php
/**
 * src/app/views/pages/admin/coupons.php
 * Kupon yönetimi sayfasının HTML yapısı.
 */
?>
<!DOCTYPE html>
<html lang="tr">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addCouponModal"><i class="bi bi-plus-circle"></i> Yeni Global Kupon</button>
            </div>
                    ...
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php else: ?>
                                    <span class="badge bg-info">Tüm Firmalar (Global)</span>
                                <?php endif; ?>
                            </td>
                            ...
                            <td>
                                <button class="btn btn-primary btn-sm edit-coupon-btn"
                                        ...
                                        data-company="<?php echo htmlspecialchars($coupon['company_name'] ?? ''); // Null ise boş string ?>">Düzenle</button>
                                <!-- action="" -> Formu kendine POST eder (/admin/coupons.php'ye) -->
...
<script src="/assets/js/admin-coupons.js"></script> <!-- admin-coupons.js dosyasını kullanıyoruz -->
</body>
</html>
