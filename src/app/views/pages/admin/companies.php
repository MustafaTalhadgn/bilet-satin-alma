<?php
/**
 * src/app/views/pages/admin/companies.php
 * Firma yönetimi sayfasının HTML yapısı.
 */
?>
<!DOCTYPE html>
<html lang="tr">
            ...
            <table class="table table-striped table-hover align-middle">
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        ...
                        <tr>
                            <td><img src="/<?php echo htmlspecialchars($company['logo_path']); // Web kökünden yol ?>" alt="" style="height: 40px;"></td>
                            ...
                            <td>
                                <button class="btn btn-primary btn-sm edit-company-btn"
                                        ...
                                        data-logo="/<?php echo htmlspecialchars($company['logo_path']); // Web kökünden yol ?>">Düzenle</button>
                                <!-- action="" -> Formu kendine POST eder (/admin/companies.php'ye) -->
...
<script src="/assets/js/admin-company.js"></script> <!-- admin-company.js dosyasını kullanıyoruz -->
</body>
</html>
